...
export const HeroData = {
  ...
  headlineTwo: "Baked With Love",
  paragraph:
    "Discover our exquisite collection of handcrafted cakes, cupcakes, and pastries. Delivered fresh to your door with secure local payment options.",
  buttonOne: "Shop Collection",
  buttonTwo: "Recipes",
  heroImage:
...
export const FeaturedData = {
  headline: "Our Bestsellers",
  subLine:
    "Hand-picked customer favorites that are guaranteed to make your special moments even sweeter.",
  button: "View All Products",
};

// services
export const ServiceData = {
  headlineOne: "Quality You Can Taste,",
  headlineTwo: "Service You Can Trust.",
  paragraph:
    "We believe that every celebration deserves the perfect cake. Our expert bakers use only premium, locally-sourced ingredients to deliver unmatched flavor and beautiful designs.",
  features: [
    {
      id: "assurance",
      icon: "shieldCheck",
      title: "100% Quality Assurance",
      para: "Rated 4.9/5 by our community. We guarantee freshness and satisfaction on every single order.",
    },
    {
      id: "social",
      icon: "",
      title: "Learn to Bake",
      para: "Purchase our exclusive digital recipes and master the art of baking in your own kitchen.",
    },
  ],
  imageOne:
